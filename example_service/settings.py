...
"""# The main settings for example_service.
...
5. Overrides from standard paths.
   - /etc/ansible-automation-platform/example_service/
6. Overrides from environment variables prefixed with EXAMPLE_SERVICE_.
...
> or set environment variables prefixed with `EXAMPLE_SERVICE_`.
...
export DJANGO_SETTINGS_MODULE=example_service.settings
...
ROOT_URLCONF = "example_service.urls"
...
WSGI_APPLICATION = "example_service.wsgi.application"
